# 생성 시간: 2025-09-01 14:07:15 KST
# 핵심 내용: 콘텐츠 노드 분석 기능 테스트 스크립트
# 상세 내용:
#   - test_single_chapter (라인 15-55): 개별 장 TOC 분석 테스트
#   - main (라인 57-75): 메인 실행 함수
# 상태: active
...
async def test_single_chapter():
    ...
    try:
        # ContentNodeAnalyzer 초기화 (새로운 설정 기반)
