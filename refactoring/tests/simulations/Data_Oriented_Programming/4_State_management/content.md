# 4 State management
(생성일시: 2025-09-10T21:04:27.471862)
...
Joe
We adopt a multi-version state approach, similar to what a version control sys-
...
System State
Figure 4.1
After mutation B is executed, the system state refers to Data V12. After 
...
Structural sharing
Theo
The information path for Watchmen’s publication year is ["catalog", "books-
...
978-1779501127
Figure 4.2
Visualization of the catalog data. The nodes in the information path to Watchmen’s publication 
...
TIP
In order to use Lodash immutable functions, we use Lodash’s FP module, and
...
var nextLibraryData = _.set(libraryData, 
  ...
  1986);
 NOTE
A function is said to be immutable when, instead of mutating the data, it cre-
...
Listing 4.1
Configuring Lodash so immutable and mutable functions have same signature
Listing 4.2
...
So far, so good . . .
Joe
Next, let me show you what an immutable function does when you use it to cre-
...
TIP
Structural sharing provides an efficient way (both in terms of memory and com-
...
Catalog
Figure 4.4
Structural sharing provides an efficient way to create a new version of the data. 
...
Theo
Take the challenge if you want. Right now, I’m too tired for this recursive algo-
rithmic stuff.
Creates a new version of 
...
(smiling) Aw, shucks.
Theo
Oops, I have to go. I’m already late for my session with Joe! Joe is probably wait-
...
instead.
Theo
Something isn’t clear to me regarding this structural sharing stuff. What hap-
...
 NOTE
All data manipulation must be done with immutable functions. It is forbid-
...
State management
Joe
That’s an excellent question. Library.addMember deals only with data calcula-
...
Joe
The code is made of two classes: System, a singleton stateful class that imple-
...
Joe
I had a feeling you were going to ask that. Here’s the code for the System-
...
Joe
To make things simple, I am going to give a number to each version of the sys-
...
Data V12
Figure 4.8
When the system state is at V12, systemData refers to V12, and 
...
Data V13
Figure 4.9
When a mutation is committed, systemData refers to V13, and 
...
Joe
Actually, it takes only a couple of changes to the SystemState class. Pay atten-
