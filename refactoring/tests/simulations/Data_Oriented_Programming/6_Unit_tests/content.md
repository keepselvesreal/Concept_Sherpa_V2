# 6 Unit tests
(생성일시: 2025-09-10T21:04:27.472953)
...
Joe
Here, I’ll draw the tree of function calls for the Library.searchBooksBy-
TitleJSON code flow.
...
Theo
On one hand, there is only a single test case in the unit test for Catalog.book-
...
TIP
Functions that appear in a lower level in the tree of function calls tend to
...
Table 6.2
The correlation between the depth of a function in the tree of function calls and the 
...
Joe
It’s inherently much more complex to compare JSON strings than it is to com-
...
ResponseData
Figure 6.6
The output of a mutation is more complex than 
...
Theo
Now, I think I’m ready to move forward and write unit tests for Library.add-
...
Joe
Writing unit tests for stateful code is more complicated than for data manipula-
...
var libraryStateBefore = {
  "userManagement": {
    "membersByEmail": {
Listing 6.27
Unit test for System.addMember
...
Theo
Thank you. I’m so glad that in DOP most of our code deals with data manipu-
...
Theo
Our cost estimate, certainly, but I know she’s in touch with other software com-
...
Generate data input 
b
Generate expected data output 
c
Compare the output of the function with the expected data output
