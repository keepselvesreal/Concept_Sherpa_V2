...
(생성일시: 2025-09-10T21:04:27.474324)
...
Exactly!
Theo
Now, here is my concern. In the case of a collection with many entries, a shal-
...
Joe
I totally agree with you. When one needs data immutability at scale, naive struc-
...
Joe
Persistent data structures are so named because they always preserve their pre-
vious versions.
TIP
...
Joe
In a language like Java, they implement the mutation methods of the collec-
...
Joe
It’s 16.6 to be precise. It means that in order to update an element in a per-
...
level of the tree.
Joe
That’s correct, up to a certain point. With today’s CPUs, using a branching fac-
...
OK.
Joe
Now, can you tell me how much memory it would take to hold a list with 10 bil-
lion elements?
Theo
...
Joe
Did I convince you that, in practice, accessing or updating an element in a per-
...
Theo
What does it take to integrate persistent data structures provided by a third-
...
Joe
Paguro collections are Java collections, so they support the Java stream inter-
...
Joe
In a language like JavaScript, it’s a bit more cumbersome to integrate per-
...
Joe
Consider the map that holds library data from our Library Management Sys-
...
manipulation?
Joe
Yes, but it’s quite easy to convert any immutable collection into a native Java-
...
// →true
Listing 9.14
Testing book search with persistent data structures
...
Immutable.setIn(userManagement,
infoPath,
member);
...
Joe
That needs to be done in two steps. You first convert the JSON string to a Java-
...
Structural diff
Theo
So far, we have ported pieces of code that dealt with simple data manipula-
...
Immutable.fromJS({
Listing 9.21
Testing structural diff with persistent data structures
