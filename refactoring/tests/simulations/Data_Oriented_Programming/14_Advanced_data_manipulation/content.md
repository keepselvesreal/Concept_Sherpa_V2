...
(생성일시: 2025-09-10T21:04:27.476671)
...
14.1
Updating a value in a map with eloquence
...
What bug?
Dave
Sometimes, the API returns duplicate author names, and we pass the dupli-
...
Theo
Being critical of our own code is an important quality for a developer to prog-
...
Listing 14.10
A list of two books with bookItems
...
Listing 14.11
Calculating the book lending ratio using forEach
...
Listing 14.12
Calculating the book lending ratio using reduce
...
{"a": true},
Listing 14.13
Calculating the book lending ratio
Listing 14.14
A unit test for countByBoolField
...
Listing 14.15
The implementation of countByBoolField
Creates a map with 
...
Listing 14.16
Unit test for grouping books by a library
...
Theo
In my case, I was dealing with an online store, where a customer cart was repre-
...
Advanced data manipulation
Theo
I’d be happy to pair program with you on this cool stuff, but I’m already run-
...
tomer cart scenario.
Listing 14.17
Grouping books by a library using unwind
"items"
{
"customer-id" : "joe",
// Other fields
...
Listing 14.18
A unit test for unwind
Listing 14.19
The implementation of unwind
