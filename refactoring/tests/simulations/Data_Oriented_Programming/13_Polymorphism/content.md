# 13 Polymorphism
(생성일시: 2025-09-10T21:04:27.476176)
...
Dave
That makes sense. Polymorphism is the ability of different objects to imple-
...
 NOTE
You should not use switch statements like this in your production code.
...
phism à la DOP.
Theo
From what I read before lunch, it seems that multimethods are a software con-
...
Theo
For that, we need a library. For instance, in JavaScript, the arrows/multi-
...
TIP
A multimethod dispatch function is responsible for three things: it defines the sig-
...
Dave
Does the method implementation have to be in the same module as the multi-
method initialization?
Theo
No, not at all! Method declarations are decoupled from multimethod initializa-
tion exactly like class definitions are decoupled from the interface definition.
That’s what make multimethods extensible.
TIP
Multimethods provides extensibility by decoupling between multimethod initial-
...
TIP
In the context of multimethods, a method is a function that provides an imple-
mentation for a dispatch value.
Dave
Are the names of dispatch functions and methods important?
Theo
According to what I read, not really, but I like to follow a simple naming con-
...
Theo
Internally, a multimethod maintains a hash map where the keys are the dis-
...
Theo
We call it as a regular function. Give me a minute, and I’ll show you an exam-
...
Dave
You told me earlier that in the dispatch function, we should validate the argu-
...
Listing 13.10
Calling a multimethod like a regular function
...
Listing 13.12
Calling a multimethod when no method fits the dispatch value
Value1
Value2
Value3
args
...
if(dev()) {
Listing 13.15
Initializing a multimethod with a dispatch function
["dog", "en"]
["cat", "en"]
["cow", "en"]
args
...
" and I speak " +
Listing 13.16
The implementation of greetLang methods
...
Dave
Now let me see if I can figure out how to use a multimethod that features mul-
tiple dispatch.
...
Listing 13.17
Calling a multimethod that features multiple dispatch
...
Theo
Now do you agree that multimethods with multiple dispatch offer a more pow-
erful polymorphism that OOP polymorphism?
Dave
Indeed, I do.
Theo
Let me show you an even more powerful polymorphism called dynamic dis-
...
Listing 13.18
A multimethod using a dispatch function with dynamic dispatch
Listing 13.19
The dysGreet methods
["dog", true]
["cat", true]
["cow", true]
args
...
Table 13.1
Text formatting for author names according to the number of books 
they have written
Number of books
Italic
Bold
...
The author schema
Listing 13.23
Author.myName multimethod initialization
...
***Isaac Asimov***    
Listing 13.24
Examples of bold and italic in HTML
Listing 13.25
The methods that deal with HTML formatting
Listing 13.26
Examples of bold and italic in Markdown
...
Dave
I don’t really know. The name appeared when I googled “data-oriented pro-
gramming” yesterday. He wrote a book on the topic. I thought it would be cool
to use its ISBN in my test. 
Listing 13.27
The methods that deal with Markdown formatting
Listing 13.28
