...
(생성일시: 2025-09-10T21:04:27.474749)
...
Joe
No, I only need a rough overview of the tables, their columns, and the relation-
...
charles-duhigg
book_authors
(relationships of books and authors)
T
...
diagram.
Joe
The data manipulation step in the diagram is implemented via generic func-
...
 NOTE
See https://node-postgres.com for more information about this collection of
...
cast it to its type.
Joe
Yes and no. Look at our book search use case. We pass all the values along with-
...
Joe
Exactly. You’ll see late binding in action in a moment. That’s one of the great-
est benefits of DOP.
Theo
...
Joe
Because I wanted to show you how you can apply DOP principles even in lan-
...
Listing 10.10
Using _.at to return multiple values from a map
...
Theo
Well, in that case, for every map returned by the database query, I’d use a func-
...
return {
Listing 10.11
Renaming columns inside the SQL query
Listing 10.12
Renaming specific keys in a list of maps
...
Listing 10.13
Renaming fields in SQL results
...
Theo
How would you write unit tests for a data manipulation function like rename-
ResultKeys?
Joe
...
"isbn": "978-1982137274",
Listing 10.14
Renaming the keys in SQL results
Listing 10.15
Unit test for renameResultKeys
...
That’s easy!
Table 10.5
Results of an SQL query that returns email and 
...
book_authors
Listing 10.16
Renaming email to userEmail
Listing 10.17
SQL query to retrieve books containing the word habit
...
Table 10.6
Results of the SQL query that retrieves books whose title contain the word habit, including
author names
title
isbn
author_name
...
Charles Duhigg
Listing 10.18
A list of maps with the results for listing 10.17
...
Listing 10.19
Aggregating author names in a list
Listing 10.20
Grouping rows by ISBN
...
"isbn": "978-0812981605",
Listing 10.21
Rows grouped by ISBN
group by isbn
aggregate author_names
title 7 Habits of Highly Eﬀective People
isbn 978-1982137274
author_name Sean Covey
title The Power of Habit
isbn 978-0812981605
...
Listing 10.23
Aggregating an arbitrary field
Listing 10.24
Test case for aggregateField
Listing 10.25
Aggregating author names in rowsByIsbn
...
"title": "The Power of Habit",
Listing 10.26
Aggregating a field in a list of rows
