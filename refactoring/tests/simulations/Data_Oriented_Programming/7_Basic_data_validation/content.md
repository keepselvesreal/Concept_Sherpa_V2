...
(생성일시: 2025-09-10T21:04:27.473390)
...
Theo
In OOP, I have this strong guarantee that when a class is instantiated, its mem-
...
Joe
In the case of a web server, it would be the areas where the web server commu-
...
JSON Schema in a nutshell
Theo
For now, the Library Management System is an application that runs in mem-
...
Joe
I see. Let me show you how to express the schema of a search request sepa-
...
Joe
We can be a little more precise about the fields property by providing infor-
...
Joe
Exactly! In fact, JSON Schema supports enumeration values with the enum key-
...
// →false
Theo
The syntax of JSON Schema is much more verbose than the syntax for declar-
...
Theo
I must admit that specifying a list of required fields is much simpler than hav-
...
to false.
Theo
What about the search request and response schema from the previous discus-
...
Correct.
Joe
Then, you need your schema to indicate that one of the isbn fields is man-
...
// →true
Theo
I see why they call it allOf and anyOf. The first one means that data must con-
...
went wrong. 
Listing 7.19
Validating an external API response
