...
(생성일시: 2025-09-10T21:04:27.472415)
...
 NOTE
This chapter requires more of an effort to grasp. The flow of the reconcilia-
...
Theo
I’m curious to discover what kind of lock mechanisms you use in DOP to syn-
...
What do you mean?
Joe
The calculation phase does its calculation as if it were the only mutation run-
...
branch.
Joe
Right! And what happens when you discover that, meanwhile, another devel-
...
Joe
When the commit phase of a mutation starts, we have three versions of the sys-
...
previous
Figure 5.4
In a three-way merge, we calculate the diff between previous and 
...
Joe
Imagine you want to calculate the sum of the elements in a collection of num-
...
Structural difference
 NOTE
This section deals with the implementation of a structural diff algorithm. Feel
...
Joe
In the general case, that’s true. But, in the case of system data that’s manipu-
lated with structural sharing, the code is much more efficient.
Theo
What do you mean?
Joe
With structural sharing, most of the nested objects are shared between two ver-
...
Listing 5.9
Structural diff between maps with two differences
