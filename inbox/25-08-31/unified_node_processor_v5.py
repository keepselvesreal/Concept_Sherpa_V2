# 생성 시간: 2025-08-31 21:59:18 KST
# 핵심 내용: 통합 노드 정보 문서의 추출 섹션 자동 생성/업데이트 시스템 - 25-08-31 전용 버전
# 상세 내용:
#   - UnifiedNodeProcessor 클래스 (40-180): 메인 처리 시스템 및 작업 조율
#   - 완전 모듈화된 구조: modules 패키지에서 모든 컴포넌트들을 import
#   - 25-08-31/config.yaml의 process_content 설정 사용
# 상태: active
# 주소: unified_node_processor_v5
# 참조: unified_node_processor_v4.py (25-08-30 버전)
...
async def main():
    ...
    parser = argparse.ArgumentParser(description='통합 노드 정보 문서 처리 시스템 v5 (25-08-31 전용)')
