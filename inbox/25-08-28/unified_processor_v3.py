# 목차
# 생성 시간: 2025-08-28 09:34:00 KST
# 핵심 내용: 25-08-28 폴더용 통합 질의응답 처리 오케스트레이터 v3 - 경로 수정 버전
# 상세 내용:
#   - sys.path 수정 (25-28): 25-08-27 폴더의 의존성 파일들 참조
#   - UnifiedProcessor 클래스 (38-280): 메인 통합 처리 시스템, 개별 문서 처리 + 보충 분석
#   - ResultCollector 클래스 (283-310): 결과 수집 및 통합
#   - setup_logging() 함수 (313-343): 파일 전용 로깅 시스템
#   - main() 함수 (346-399): CLI 인터페이스
# 상태: active
# 주소: unified_processor_v3/25-08-28
# 참조: 25-08-27/unified_processor_v3.py (경로 수정 및 25-08-28 폴더 적응)
...
# 상위 디렉토리(25-08-27)를 Python 경로에 추가
sys.path.insert(0, str(Path(__file__).parent.parent / '25-08-27'))
