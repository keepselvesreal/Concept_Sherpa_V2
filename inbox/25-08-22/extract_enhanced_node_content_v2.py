#!/usr/bin/env python3
"""
생성 시간: 2025-08-22 14:55:15
핵심 내용: extraction 폴더에서 노드 정보 문서 찾아 주요 정보 추출하는 스크립트
상세 내용: 
    ...
    - ExtractionConfig, AIProvider 클래스들: 기존 스크립트에서 동일하게 유지
상태: active
...
def main():
    """메인 실행 함수"""
    if len(sys.argv) != 2:
        print("Usage: python extract_enhanced_node_content_v2.py <extraction_folder>")
        print("Example: python extract_enhanced_node_content_v2.py ./YouTube_250822")
        sys.exit(1)
